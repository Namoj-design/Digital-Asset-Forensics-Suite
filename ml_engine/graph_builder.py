...
class GraphBuilder:
    def __init__(self, tx_file=None, labels_file=None):
        self.tx_file = tx_file or os.path.join(BASE_DIR, "Dataset", "transactions.csv")
        self.labels_file = labels_file or os.path.join(BASE_DIR, "Dataset", "node_labels.csv")
